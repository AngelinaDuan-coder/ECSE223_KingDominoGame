...
package ca.mcgill.ecse223.kingdomino.view.ca.mcgill.ecse223.kingdomino.model;
...
import ca.mcgill.ecse223.kingdomino.view.Game_3_Players;
import ca.mcgill.ecse223.kingdomino.view.Game_3_Players;
import java.io.IOException;

/**
 * ///////////////////////////////////
 * This is for 3_Player game only!////
 * ///////////////////////////////////
 */
// line 9 "../../../../../../../../../../Gameplay.ump"


/**For 3_player game only!
 * 
 * @author chenkua
 *
 */
public class Gameplay_3
{
  ...
  public boolean selectingFirstDraftDomino(int domino)
  {
    ...
    switch (aGamestatusInitializing)
    {
      case SelectingFirstDomino:
        if (DominoSelectable(domino)&&getSelectingOrder()<2)
        {
          exitGamestatusInitializing();
        // line 82 "../../../../../../../../../../Gameplay.ump"
          selectingFirst(domino);
	   			    	setPlayerOrderNextDraft(domino);
	                	selectingOrder = (selectingOrder+1)%3;
          setGamestatusInitializing(GamestatusInitializing.SelectingFirstDomino);
          wasEventProcessed = true;
          break;
        }
  ...
  public boolean discard()
  {
    ...
    switch (aGamestatusProceedingToNextTurnProceedingToPlaceDomino)
    {
      case placingDomino:
        ...
        if (shouldDiscardDomino()&&(getTotal_No_Draft()>=12)&&(getPlacingOrder()<2))
        {
          exitGamestatusProceedingToNextTurnProceedingToPlaceDomino();
    ...
    switch (aGamestatusProceedingToNextTurnProceedingToPlaceDomino)
    {
      case placingDomino:
        ...
        // line 162 "../../../../../../../../../../Gameplay.ump"
          verifyPlacement();placingOrder=(placingOrder+1)%3;
          setGamestatusProceedingToNextTurnProceedingToPlaceDomino(GamestatusProceedingToNextTurnProceedingToPlaceDomino.choosingNextDomino);
          wasEventProcessed = true;
          break;
        }
        if (preplaceDomino()&&(getTotal_No_Draft()>=12)&&(getPlacingOrder()<2))
        {
          exitGamestatusProceedingToNextTurnProceedingToPlaceDomino();
   ...
   */
  // line 309 "../../../../../../../../../../Gameplay.ump"
   public void updateTwoDraftPostion(){
    Game_3_Players.refreshSelectioBeforeColumn1();
	Game_3_Players.RefreshDrafts_1();
	Game_3_Players.clearColumn_2();
  }
  ...
  // line 547 "../../../../../../../../../../Gameplay.ump"
   public void displayRanking(){
    // TODO: implement this
  }

  // line 555 "../../../../../../../../../../Gameplay.ump"
   public void choose_Other_Placement(){
    Game_3_Players.warningInPlacing();
  }
  ...
  // line 593 "../../../../../../../../../../Gameplay.ump"
   public boolean preplaceDomino(){
    ...
    if(size==1) {	
    	Game_3_Players.warningInPreplacing();
    	return false;
    }   
   ...
   * @author chenkua
   */
  // line 637 "../../../../../../../../../../Gameplay.ump"
   public void upDatePlayerOrder(){
    Game_3_Players.setCurrentOrder();
  }
  ...
  // line 645 "../../../../../../../../../../Gameplay.ump"
   public boolean shouldDiscardDomino(){
	...
	DirectionKind initialDirection = tmp.getDirection();
		...
		tmp.delete();
		Game_3_Players.SuccessDiscarding();
		return true;
  }
    ...
    Player current = game.getCurrentOrder(selectingOrder);
	   ...
	   for(Player p : game.getCurrentOrder()) {
		   if(!p.equals(current) && p.getDominoSelection()!=null && p.getDominoSelection().getDomino().getId()==i) {
			  ...
			  Game_3_Players.warningInSelecting();
			   return false;
		   }
    ...
    int size = game.getCurrentOrder(placingOrder).getKingdom().getTerritories().size();
	   ...
	   if(size>1) {
		   ...
		   try {
			...
			Game_3_Players.warningInMoving();
			e.printStackTrace();
		}
	   }else {
  ...
  // line 861 "../../../../../../../../../../Gameplay.ump"
   public void WarningInDiscarding(){
    Game_3_Players.warningInDiscarding();
  }
   ...
   public boolean moveable(){
    Player aPlayre = game.getCurrentOrder(placingOrder);
	   ...
	   if(DIK.getDomino().getStatus()==DominoStatus.PlacedInKingdom) {
		  Game_3_Players.warningAfterMoving();
		  return false; 
	   }
